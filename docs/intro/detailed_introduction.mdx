...
The protocol can be thought of as a collateral loan whereby the borrower borrows TCAP against the deposited collateral. 
...
The ratio between the value of the collateral deposited and the value of TCAP borrowed is called the vault ratio. 
...
A user can reduce their debt by destroying some of the minted TCAP. This process of reducing the supply of TCAP tokens is called burning.
